...
| Repository | Purpose |
|---|---|
| **[literary-compilation](https://github.com/marconian/literary-compilation)** | The Divine Bricolage framework — knowledge graph, source documents, theological synthesis |
| **[structured-data-analysis](https://github.com/marconian/structured-data-analysis)** | Empirical data analysis — NDE, past-life memory, MallWorld dream phenomenology |
